 ...
 * 默认工具栏配置（显示所有工具）
 */
export declare const DEFAULT_TOOLBAR_CONFIG: ToolbarToolsConfig;
/**
 * 基础版工具栏配置（只显示基础功能）
 */
export declare const BASIC_TOOLBAR_CONFIG: ToolbarToolsConfig;
/**
 * 进阶版工具栏配置（包含更多功能）
 */
export declare const ADVANCED_TOOLBAR_CONFIG: ToolbarToolsConfig;
